//
//  UIColor+PreSetup.swift
//  a1minton
//
//  Created by HoJun Lee on 2016. 5. 21..
...
extension UIColor {
    ...
    var pointColor: UIColor {
        get {
            return UIColor(red: 189/255.0, green: 212/255.0, blue: 48/255.0, alpha: 1)
        }
    }
    ...
    var subOneColor: UIColor {
        get {
            return UIColor(red: 100/255.0, green: 101/255.0, blue: 103/255.0, alpha: 1)
        }
    }
    
    var subTwoColor: UIColor {
        get {
            return UIColor(red: 66/255.0, green: 66/255.0, blue: 66/255.0, alpha: 1)
        }
    }
    
    var maleColor: UIColor {
        get {
            return UIColor(red: 3/255.0, green: 169/255.0, blue: 244/255.0, alpha: 1)
        }
    }
    
    var femaleColor: UIColor {
        get {
